...
public class PostData {
	...
	public void addUser() {
		...
		requestParameters.put("firstName", "khus");
		requestParameters.put("lastName", "kumari");
		requestParameters.put("email", "khushbu@simpragma.com");
		requestParameters.put("password", "khushbu@123");
